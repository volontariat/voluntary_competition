module VoluntaryCompetition
  class Engine < ::Rails::Engine
    ...
    config.to_prepare do
      User.send :include, ::VoluntaryCompetition::Concerns::Model::User::Competitive
      ::Ability.add_after_initialize_callback(VoluntaryCompetition::Ability.after_initialize)
    end
  end
end
